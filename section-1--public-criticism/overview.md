...
> . . . You can't remove interactivity from the medium, by definition. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgzpndI-D6jXbbsLX1J4AaABAg)

> . . . you kind of have to include some basic mechanics (or gameplay, if you will) for it to be a game. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgzjOmHhwvfO17RPkqd4AaABAg)

> If you don't need gameplay to push the story... pick a different medium to tell it. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugx0wCYL8x4nimkl8eF4AaABAg)

> . . . the guy completely missed the point of what a Video Game is able to do . . . [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgzqEFCOVevMuNJFjDd4AaABAg)

> . . . for gaames in particular though the thought experiment of "What is [X] without [defining feature]" is a little less interesting because we Have media without game play; they're called movies. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgyDrvoZ0NzIGFuLE-h4AaABAg)

> The idea that a game must have a “point” that’s separate from the gameplay, and the gameplay must be either supporting or in conflict with it, rather than the gameplay itself being the point, is honestly bizarre to me [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugxs_vaSPKuynouUNr14AaABAg)

^ a stretch, but i think this person is coming from a place of 'gameplay [is] the point' because of the medium it's a part of... really a stretch though, i don't mean to lump them in with the _exclusivity_ of gameplay as the source of meaning in games
...
there are a number of statements that use terms without defining them... in theory i could dig more into these to get some more information but i think that would be a serious distraction, can only investigate claims so far

> . . . gameplay is art. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugx5OGJt5HFOYOzZ54F4AaABAg)

## claims about artist intention or the meaning of a work (droqen thinks x, the game states x) with no evidence given

as with nonsense statements, since these are not grounded in anything, i think it is not worth looking deeply into this

> . . . now that I'm at the end of the video it's looking more and more like this guy should learn about absurdism. Yeah man none of this has any meaning not even the stuff you see as having value and that's okay the struggle is enough to fill one's heart!!! [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugy_HlwIuxz6KMq0v_V4AaABAg)

^Assumption that 'this guy' does not know about absurdism and that the work is not absurdist? 

## we already have games without gameplay! (usually citing IF, sandbox games)

> You want games without failure states or challenges? Interactive fiction, visual novels, and sandbox games are thriving [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgyjMbcCxRbYYa5PCjx4AaABAg)

## kill gameplay is presented objective but it's actually subjective / just a matter of opinion

> . . . Droqen and the people behind Dogme 95 have the opinion that there is a correct way to create something, and a wrong way, and the way THEY like things is objectively correct. // This is . . . objectively incorrect. . . . If you look at something and you don't like it, feel free to critique it.  But don't look at things you don't like and begin to believe that your viewpoint is the only correct viewpoint to have. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugx5ey2U0FbJC4eU5MB4AaABAg)

> . . . its clear that what or how people may see in games changes from person to person. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugw2M4i0ZGKVHwbAXjV4AaABAg)

> I think as soon as you've begun an argument with "Art should / should be...", you've already lost. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugztle4ev7Iuscu0kD14AaABAg&pp=0gcJCSIANpG00pGi)

> “Kill gameplay” -> “Kill gameplay that I don’t like”
...
> it’s weird to me how focused he is on the idea that play should have a purpose… like isn’t the point of play to just… play? [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugxs_vaSPKuynouUNr14AaABAg)
...
> . . . the fourth step of Maslow's pyramid - "Prestige, legacy", more known as "Sense of achievement". The same sense that pushes us to do things apart from eating or conversing is also the reason we play "sudoku". We want to do something. We want to "have fun". . . this necessity is one thing. Painting and art in general is the fifth step - "Art and self-realisation", a whole different thing, yet of same importance. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgwVMeCYe9fkzcExTdZ4AaABAg)
...
> I can understand being a bit cynical in a world with hollow games that exist to be addicting [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugztle4ev7Iuscu0kD14AaABAg&pp=0gcJCSIANpG00pGi)

## kill gameplay is anti-entertainment
...
> The dev views everything as worthless instead of being able to see the value in doing something, even when the value isn't some specific physical reward. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugxg_uBgIzcFFouflaJ4AaABAg)

> [The game is] trying to make a statement about how everything is futile. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgymdeDYys7jW1AcIb54AaABAg)

> I think the average answer to "Bunnies" is exactly why this initiative misses the point. // "Why did you grab all the coins?" [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgwxDdVsAi1jpw1pGUV4AaABAg)

^Gotta think about this one, it's subtler but supposes that bunnies is nihilism-adjacent, a loaded question that implies that there's no meaning

> "I collected the coins even though there was nothing to spend them on" // Yeah, collecting things is fun. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgyjECKwEPOALBcQHwl4AaABAg)

^Created a pathway to resolve this one, see pathway 1.2
...
## exclusivity of medium effect; this medium delivers something that cannot be delivered via another method (may also include specific criticism of specific choices of medium)

> whether gameplay (particularly arbitrary challenges) are actually a "cost" - or whether they can be the meaning themselves - or at least a helpful, flowing conduit to feel the meaning more viscerally.  Living it can be more meaningful than reading it in blocky white text. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugz3cfPvgQulO4f7g5V4AaABAg)

^ low-key criticism, but definitely criticism! describing "Living it" (gameplay) as a more effective conduit for meaning than "reading it in blocky white text"

> . . . well thought out and precisely implemented game mechanics can really drive home the entire point of the art. . . . the gameplay mirrors the emotional climax in a way that most other forms of media could never achieve. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgzR1KRTRuGuW2u2S7t4AaABAg)
...
> I take issue with the entire concept of games being unique in the necessity of 'costs'. ALL art has costs, all art. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgyNDFz7Mbf3dn6W0i14AaABAg)

see `pathway-1-1`, where this topic of cost being unique to games is discussed.

> All art has costs. Clearing a mechanical challenge is little different than any other cost, save that its a new kind more people are less familiar with. [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=UgyNDFz7Mbf3dn6W0i14AaABAg)
...
^ ah, wow, i disagree the most. big marketing brain mindset

> the kill gameplay philosophy  goes against the nature of video games and why people play them [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugw9nrJJP-dFs7uRgKt4AaABAg)

> why does anyone create art? is it not to share it? [@](https://www.youtube.com/watch?v=6qmt9LX8pTI&lc=Ugz25_9Wa-9uGQxo8o94AaABAg)
